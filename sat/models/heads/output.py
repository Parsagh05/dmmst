...
class SAOutput(ModelOutput):
    ...
    Args:
        ...
        attentions (`tuple(torch.FloatTensor)`, *optional*, returned when `output_attentions=True` is passed or when `config.output_attentions=True`):
            ...
            heads.
        shape / scale / logits_g (`torch.FloatTensor`, *optional*):
            Mixture parameters emitted by the DSM/MENSA baseline heads.
        event_dependency_matrix (`torch.FloatTensor`, *optional*):
            Inter-event dependency matrix emitted by the MENSA baseline head.
    """
    ...
    # --- baseline-only fields (DSM / MENSA parametric heads; see SCOPE.md) ---
