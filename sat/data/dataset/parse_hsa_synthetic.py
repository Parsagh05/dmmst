...
class hsa:
    ...
    def __call__(self) -> None:
        ...
        # NOTE: assign the column directly, not through .loc[:, col]. Assigning an
        # astype("object") result back through .loc keeps the original (string)
        # dtype on modern pandas, so the later .at[index, col] = <list> raises
